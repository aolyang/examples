...
APP.Main = (function () {
  ...
  var storyDetails = document.getElementById('sd-target')
  ...
  function showStory(id) {
    if (!storyDetails.className.includes('show-story-details')) {
      storyDetails.classList.add('show-story-details')
    }
  }

  function hideStory(id) {
    storyDetails.classList.remove('show-story-details')
  }
